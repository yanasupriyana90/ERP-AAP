        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if ($purchaseOrders->isEmpty())
                    <tr>
                        <td colspan="9" class="text-center">Tidak ada Purchase Order yang tersedia.</td>
                    </tr>
                @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($po->status == 1 && ($po->user_id == Auth::id() || Auth::user()->role === 'Superuser'))
                                                <a href="{{ route('purchase-orders.print', $po->id) }}" class="btn btn-sm btn-secondary" target="_blank">
                                            ...
                                            @if (Auth::user()->role === 'Superuser' || $po->user_id == Auth::id())
                                                @if ($po->status == 0)
                                                    <!-- Jika Pending, hanya pembuat dan Superuser yang bisa edit & hapus -->
